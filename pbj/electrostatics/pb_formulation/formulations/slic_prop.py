...
def create_ehat_stern(self):
    ...
    d1_op = bempp.api.assembly.boundary_operator.MultiplicationOperator(d1_gridfun, neumann_space_stern, neumann_space_stern, neumann_space_stern) 
...
def calculate_potential(self, rerun_all):
    ...
    while it < max_iterations and phi_L2error > tolerance:
        ...
        if it == 0:
            ...
            pbj.electrostatics.pb_formulation.formulations.slic.create_ehat_diel(self, sigma)
