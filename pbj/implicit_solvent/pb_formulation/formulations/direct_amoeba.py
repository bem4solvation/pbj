...
def block_diagonal_preconditioner(solute):
    pbj.implicit_solvent.pb_formulation.formulations.direct.block_diagonal_preconditioner(
        solute
    )


def mass_matrix_preconditioner(solute):
    pbj.implicit_solvent.pb_formulation.formulations.direct.mass_matrix_preconditioner(
        solute
    )


def mass_matrix_preconditioner_rhs(solute):
    pbj.implicit_solvent.pb_formulation.formulations.direct.mass_matrix_preconditioner_rhs(
        solute
    )
